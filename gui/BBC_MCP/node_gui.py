...
class BBC_MCPGUI(QWidget):
    """GUI widget for BBC_MCP detector"""
    ...
    def __init__(self, parent=None):
        ...
        self.node_name = "BBC_MCP"
        self.full_name = "BBC MCP Detector"
        self.color = "#27ae60"
        self.icon = "🔵"
...
if __name__ == "__main__":
    ...
    widget = BBC_MCPGUI()
    widget.setWindowTitle("BBC MCP Detector Control Panel")
