...
class SPDGUI(QWidget):
    """GUI widget for SPD detector"""
    ...
    def __init__(self, parent=None):
        ...
        self.node_name = "SPD"
        self.full_name = "Silicon Pixel Detector"
        self.color = "#3498db"
        self.icon = "🎯"
...
if __name__ == "__main__":
    ...
    widget = SPDGUI()
    widget.setWindowTitle("Silicon Pixel Detector Control Panel")
