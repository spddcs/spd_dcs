#!/usr/bin/env python3
"""StrawTracker Detector Panel with Picture Only"""
...
class StrawTrackerPanel(BaseNodePanel):
    def __init__(self, device=None, parent=None):
        super().__init__("StrawTracker", device, parent)
    ...
    def setup_ui(self):
        ...
        picture_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "pictures", "strawtracker.png")
        ...
        if os.path.exists(picture_path):
            ...
            placeholder_label = QLabel("StrawTracker Detector Image\n\n(strawtracker.png not found)\n\nPlace image in:\n/home/shkar/SPD_DCS/pictures/strawtracker.png")
...
def get_panel(device=None):
    return StrawTrackerPanel(device)
...
def main():
    ...
    panel = StrawTrackerPanel()
    panel.setWindowTitle("StrawTracker Detector")
    panel.show()
    sys.exit(app.exec_())
