#!/usr/bin/env python3
"""SPD Detector Panel with Picture Only"""
...
class SPDPanel(BaseNodePanel):
    def __init__(self, device=None, parent=None):
        super().__init__("SPD Detector", device, parent)
    ...
    def setup_ui(self):
        ...
        picture_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "pictures", "spd.png")
        ...
        if os.path.exists(picture_path):
            ...
            placeholder_label = QLabel("SPD Detector Image\n\n(spd.png not found)\n\nPlace image in:\n/home/shkar/SPD_DCS/pictures/spd.png")
...
def main():
    ...
    panel = SPDPanel()
    panel.setWindowTitle("SPD Detector")
    panel.show()
    sys.exit(app.exec_())
