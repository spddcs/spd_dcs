...
class StrawTrackerGUI(QWidget):
    """GUI widget for StrawTracker detector"""
    ...
    def init_ui(self):
        ...
        # Title
        title = QLabel("StrawTracker Detector Control")
    ...
    def start_detector(self):
        """Start the detector"""
        print(f"Starting StrawTracker detector...")
        self.status_label.setText("Starting...")
        
    def stop_detector(self):
        """Stop the detector"""
        print(f"Stopping StrawTracker detector...")
        self.status_label.setText("Stopped")

def get_widget():
    """Function to return widget for master GUI"""
    return StrawTrackerGUI()

if __name__ == "__main__":
    from PyQt5.QtWidgets import QApplication
    app = QApplication(sys.argv)
    widget = StrawTrackerGUI()
    widget.show()
    sys.exit(app.exec_())
