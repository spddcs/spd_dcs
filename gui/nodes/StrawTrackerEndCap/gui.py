#!/usr/bin/env python3
"""
GUI for StrawTrackerEndCap detector
...
class StrawTrackerEndCapGUI(QWidget):
    """GUI widget for StrawTrackerEndCap detector"""
    ...
    def init_ui(self):
        ...
        # Title
        title = QLabel("StrawTrackerEndCap Detector Control")
    ...
    def start_detector(self):
        """Start the detector"""
        print(f"Starting StrawTrackerEndCap detector...")
        self.status_label.setText("Starting...")
        
    def stop_detector(self):
        """Stop the detector"""
        print(f"Stopping StrawTrackerEndCap detector...")
        self.status_label.setText("Stopped")

def get_widget():
    """Function to return widget for master GUI"""
    return StrawTrackerEndCapGUI()

if __name__ == "__main__":
    from PyQt5.QtWidgets import QApplication
    app = QApplication(sys.argv)
    widget = StrawTrackerEndCapGUI()
    widget.show()
    sys.exit(app.exec_())
