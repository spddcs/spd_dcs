...
class BBCGUI(QWidget):
    """GUI widget for BBC detector"""
    ...
    def init_ui(self):
        ...
        # Title
        title = QLabel("BBC Detector Control")
    ...
    def start_detector(self):
        """Start the detector"""
        print(f"Starting BBC detector...")
        self.status_label.setText("Starting...")
        
    def stop_detector(self):
        """Stop the detector"""
        print(f"Stopping BBC detector...")
