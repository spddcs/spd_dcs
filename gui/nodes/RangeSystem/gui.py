...
class RangeSystemGUI(QWidget):
    """GUI widget for RangeSystem detector"""
    ...
    def init_ui(self):
        ...
        # Title
        title = QLabel("RangeSystem Detector Control")
    ...
    def start_detector(self):
        """Start the detector"""
        print(f"Starting RangeSystem detector...")
        self.status_label.setText("Starting...")
        
    def stop_detector(self):
        """Stop the detector"""
        print(f"Stopping RangeSystem detector...")
        self.status_label.setText("Stopped")

def get_widget():
    """Function to return widget for master GUI"""
    return RangeSystemGUI()

if __name__ == "__main__":
    from PyQt5.QtWidgets import QApplication
    app = QApplication(sys.argv)
    widget = RangeSystemGUI()
    widget.show()
    sys.exit(app.exec_())
