#!/usr/bin/env python3
"""
GUI for RangeSystemEndCap detector
...
class RangeSystemEndCapGUI(QWidget):
    """GUI widget for RangeSystemEndCap detector"""
    ...
    def init_ui(self):
        ...
        # Title
        title = QLabel("RangeSystemEndCap Detector Control")
    ...
    def start_detector(self):
        """Start the detector"""
        print(f"Starting RangeSystemEndCap detector...")
        self.status_label.setText("Starting...")
        
    def stop_detector(self):
        """Stop the detector"""
        print(f"Stopping RangeSystemEndCap detector...")
        self.status_label.setText("Stopped")

def get_widget():
    """Function to return widget for master GUI"""
    return RangeSystemEndCapGUI()

if __name__ == "__main__":
    from PyQt5.QtWidgets import QApplication
    app = QApplication(sys.argv)
    widget = RangeSystemEndCapGUI()
    widget.show()
    sys.exit(app.exec_())
