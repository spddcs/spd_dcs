#!/usr/bin/env python3
"""BBC Detector Panel with Picture Only"""
...
class BBCPanel(BaseNodePanel):
    def __init__(self, device=None, parent=None):
        super().__init__("BBC Detector", device, parent)
    ...
    def setup_ui(self):
        ...
        picture_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "pictures", "bbc.png")
        ...
        if os.path.exists(picture_path):
            ...
            placeholder_label = QLabel("BBC Detector Image\n\n(bbc.png not found)\n\nPlace image in:\n/home/shkar/SPD_DCS/pictures/bbc.png")
...
def main():
    ...
    panel = BBCPanel()
    panel.setWindowTitle("BBC Detector")
    panel.show()
    sys.exit(app.exec_())
