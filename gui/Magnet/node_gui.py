...
class MagnetGUI(QWidget):
    """GUI widget for Magnet detector"""
    ...
    def __init__(self, parent=None):
        ...
        self.node_name = "Magnet"
        self.full_name = "Magnet Control System"
        self.color = "#9b59b6"
        self.icon = "🧲"
...
if __name__ == "__main__":
    ...
    widget = MagnetGUI()
    widget.setWindowTitle("Magnet Control System Control Panel")
