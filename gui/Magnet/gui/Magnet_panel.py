#!/usr/bin/env python3
"""Magnet Control Panel with Picture Only"""
...
class MagnetPanel(BaseNodePanel):
    def __init__(self, device=None, parent=None):
        super().__init__("Magnet Control", device, parent)
    ...
    def setup_ui(self):
        ...
        picture_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "pictures", "magnet.png")
        ...
        if os.path.exists(picture_path):
            ...
            placeholder_label = QLabel("Magnet Detector Image\n\n(magnet.png not found)\n\nPlace image in:\n/home/shkar/SPD_DCS/pictures/magnet.png")
...
def main():
    ...
    panel = MagnetPanel()
    panel.setWindowTitle("Magnet Control")
    panel.show()
    sys.exit(app.exec_())
