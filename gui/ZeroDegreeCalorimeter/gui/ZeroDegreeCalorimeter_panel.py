#!/usr/bin/env python3
"""Zero Degree Calorimeter Panel with Picture Only"""
...
class ZeroDegreeCalorimeterPanel(BaseNodePanel):
    def __init__(self, device=None, parent=None):
        super().__init__("Zero Degree Calorimeter", device, parent)
    ...
    def setup_ui(self):
        ...
        picture_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "pictures", "zerodegreecalorimeter.png")
        ...
        if os.path.exists(picture_path):
            ...
            placeholder_label = QLabel("Zero Degree Calorimeter Image\n\n(zerodegreecalorimeter.png not found)\n\nPlace image in:\n/home/shkar/SPD_DCS/pictures/zerodegreecalorimeter.png")
...
def get_panel(device=None):
    return ZeroDegreeCalorimeterPanel(device)
...
def main():
    ...
    panel = ZeroDegreeCalorimeterPanel()
    panel.setWindowTitle("Zero Degree Calorimeter")
    panel.show()
    sys.exit(app.exec_())
