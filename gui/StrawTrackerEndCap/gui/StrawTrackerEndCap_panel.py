#!/usr/bin/env python3
"""StrawTracker End Cap Panel with Picture"""
...
class StrawTrackerEndCapPanel(BaseNodePanel):
    def __init__(self, device=None, parent=None):
        super().__init__("Straw Tracker End Cap", device, parent)
    ...
    def setup_ui(self):
        ...
        picture_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "pictures", "strawtrackerendcap.png")
        ...
        if os.path.exists(picture_path):
            ...
            placeholder_label = QLabel("Straw Tracker End Cap Image\n\n(strawtrackerendcap.png not found)\n\nPlace image in:\n/home/shkar/SPD_DCS/pictures/strawtrackerendcap.png")
...
def get_panel(device=None):
    return StrawTrackerEndCapPanel(device)
...
def main():
    ...
    panel = StrawTrackerEndCapPanel()
    panel.setWindowTitle("Straw Tracker End Cap")
    panel.show()
    sys.exit(app.exec_())
